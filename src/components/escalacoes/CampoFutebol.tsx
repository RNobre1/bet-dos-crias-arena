...
const CampoFutebol: React.FC<CampoFutebolProps> = ({ timeA, timeB, showTeam }) => {
  const renderPlayer = (player: TeamPlayer, isTeamA: boolean) => (
    <div
      ...
      } shadow-lg min-w-[80px] max-w-[100px]`}
    >
      <div className="text-lg font-bold">{player.nota.toFixed(1)}</div>
    ...
    <div className="relative w-full max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          {/* Áreas do goleiro */}
          <div className="absolute top-4 left-1/2 w-32 h-16 border-2 border-white transform -translate-x-1/2"></div>
          <div className="absolute bottom-4 left-1/2 w-32 h-16 border-2 border-white transform -translate-x-1/2"></div>
        </div>
